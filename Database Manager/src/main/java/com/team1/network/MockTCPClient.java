...
public class MockTCPClient
{
     ...
     */
    public MockTCPClient(String host, int port) throws InvalidKeyException,
            IOException
    {
        this(host, port, 0);
    }
     ...
     * @throws InvalidKeyException An error has occurred when initializing the encryption
     */
    public MockTCPClient(String host, int port, int timeout) throws IOException, InvalidKeyException
    {
