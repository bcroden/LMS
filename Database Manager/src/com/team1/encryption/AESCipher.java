...
/**
 * A cipher utilizing the AES algorithm.
 * This cipher will encrypt and decrypt messages using a shared 128-bit key.
 * 
...
public class AESCipher {
	...
	/**
	 * Create an AESCipher object. This will regenerate an AES key based on the provided byte[].
	 * 
	 * @param key - A byte[] representing a SecretKey.
	 */
	...
	/**
	 * Create an AESCipher object. This will use the provided SecretKey for the key.
	 * 
	 * @param key - A valid AES SecretKey
	 */
	...
	/**
	 * This method will run the AES encryption algorithm on the provided message.
	 * 
	 ...
	 * 
	 * @param encryptedMessage - The byte[] containing the encrypted bytes
