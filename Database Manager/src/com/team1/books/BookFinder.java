...
/**
 * This class will lookup a book by its ISBN on Google and return a Book object representing that data.
 * 
 * @author Brandon
 *
 */
public class BookFinder {
    ...
    /**
     * Will return a Book containing information found on Google for the given ISBN
     * 
     * @param isbn -  The ISBN of the book you want to look up
     * @return A book containing the data for the specified ISBN
     * @throws InvalidISBNException If the entered ISBN is of improper length, or is not registered on Google
     */
    public static Book getBookFromGoogle(String isbn) throws InvalidISBNException {
        ...
        //Return the book
        return new Book(isbn, title, author, publisher, datePublished);
    }
